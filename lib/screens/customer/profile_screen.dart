// screens/customer/profile_screen.dart
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:xangdau_app/models/user.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _navigateToOrderHistory() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Không thể tải lịch sử đơn hàng. Vui lòng thử lại sau.'),
